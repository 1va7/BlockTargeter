...
__export(src_exports, {
  ...
  etherAddressToCompactPubkey: () => etherAddressToCompactPubkey,
  etherAddressToSubstrateAddress: () => etherAddressToSubstrateAddress,
  fixture: () => fixture,
  ...
  unstable_signEip712Certificate: () => unstable_signEip712Certificate
});
...
async function etherAddressToCompactPubkey(client, account) {
  ...
  const sign = await (0, import_wallet.signMessage)(client, { account, message: msg });
  const hash = (0, import_viem.hashMessage)(msg);
  const recovered = await (0, import_viem.recoverPublicKey)({ hash, signature: sign });
  const compactPubkey = (0, import_util.u8aToHex)((0, import_util_crypto.secp256k1Compress)((0, import_util.hexToU8a)(recovered)));
...
async function etherAddressToSubstrateAddress(client, account) {
  ...
  const substratePubkey = (0, import_util_crypto.encodeAddress)((0, import_util_crypto.blake2AsU8a)((0, import_util.hexToU8a)(compactPubkey)), 42);
...
function generatePair() {
  ...
  const generatedPair = (0, import_util_crypto2.sr25519PairFromSeed)(generatedSeed);
...
async function signCertificate(params) {
  ...
  if (isUsingSigner(params)) {
    ...
    signerPubkey = (0, import_util2.u8aToHex)((0, import_util_crypto2.decodeAddress)(address));
    if (!signatureType) {
...
async function unstable_signEip712Certificate({
  ...
  const signature = await (0, import_wallet2.signTypedData)(
    client,
...
function EncryptedInkCommand(address, encParams, nonce, value, gas, storageDepositLimit) {
  ...
  const commandAgreementKey = (0, import_util_crypto3.sr25519Agreement)(sk, (0, import_util10.hexToU8a)(address));
...
async function pinkQuery(pruntimeApi, pk, queryAgreementKey, encodedQuery, { certificate, pubkey, secret }) {
  ...
  const signature = {
    ...
    signature: (0, import_util_crypto4.sr25519Sign)(encodedEncryptedData, { publicKey: pubkey, secretKey: secret })
  };
  const requestData = {
...
var PinkContractPromise = class {
  constructor(api, phatRegistry, abi, address, contractKey) {
    ...
    this.#inkQuery = (isEstimating, messageOrId, options2, params) => {
      ...
      const queryAgreementKey = (0, import_util_crypto5.sr25519Agreement)(sk, (0, import_util15.hexToU8a)((0, import_util15.hexAddPrefix)(this.phatRegistry.remotePubkey)));
...
var PinkBlueprintPromise = class {
  constructor(api, phatRegistry, abi, codeHash) {
    ...
    this.#estimateGas = (constructorOrId, options2, params) => {
      ...
      const pair = (0, import_util_crypto6.sr25519PairFromSeed)(seed);
      const [sk, pk] = [pair.secretKey, pair.publicKey];
      const { cert } = options2;
      const queryAgreementKey = (0, import_util_crypto6.sr25519Agreement)(sk, (0, import_util17.hexToU8a)((0, import_util17.hexAddPrefix)(this.phatRegistry.remotePubkey)));
      const inkQueryInternal = async (origin) => {
        if (typeof origin === "string") {
          assert(origin === cert.address, "origin must be the same as the certificate address");
        } else if (origin.hasOwnProperty("verify") && origin.hasOwnProperty("adddress")) {
...
function sidevmQueryWithReader({ phactory, remotePubkey, address, cert }) {
  return async function unsafeRunSidevmQuery(sidevmMessage) {
    ...
    const queryAgreementKey = (0, import_util_crypto7.sr25519Agreement)(sk, (0, import_util19.hexToU8a)((0, import_util19.hexAddPrefix)(remotePubkey)));
...
function getTopicHash(topic) {
  ...
  if (encoded.length > 32) {
    return (0, import_util19.u8aToHex)((0, import_util_crypto7.blake2AsU8a)(encoded));
  } else {
...
var OnChainRegistry = class _OnChainRegistry {
  ...
  get alice() {
    if (!this.#alice) {
      const keyring = new import_api5.Keyring({ type: "sr25519" });
...
async function getClient(opts) {
  ...
  const provider = typeof transport === "string" ? new import_api6.WsProvider(transport) : transport;
  const api = await import_api6.ApiPromise.create(options({ provider, noInitWarn: true }));
...
async function getLogger(options2) {
  if ("transport" in options2) {
    ...
    await (0, import_util_crypto9.cryptoWaitReady)();
